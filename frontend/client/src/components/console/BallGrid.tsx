      ...
      {visibleStats.map(stat => {
        ...
        return (
          ...
          >
            ...
            {/* Wrapper boule avec badge ancre NEXUS délégué à LottoBall */}
            <div className="relative">
              <LottoBall
                ...
                isAncre={nexusActive && (type === 'number' ? nexusAncreNums : nexusAncreStars).includes(stat.number)}
                className={cn(
