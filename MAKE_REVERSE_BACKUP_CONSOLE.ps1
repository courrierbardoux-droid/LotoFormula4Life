...
$srcFile = 'C:\Projects\LotoFormula4Life\frontend\client\src\pages\Console.tsx'
Copy-Item -Force -Path $srcFile -Destination (Join-Path $destPages 'Console.tsx')

Set-Content -Encoding UTF8 -Path (Join-Path $dest 'LISTE_FICHIERS_MODIFIES.txt') -Value @(
  'frontend/client/src/pages/Console.tsx'
)
