...
2. **Période récente** = les `R` derniers tirages (`R` fixé en dur à 30 aujourd’hui).
...
- Dans `calculerTendances`, la “période récente” doit être **R\*** au lieu de 30 en dur (ou être parametrable via W* et R*).
...
## 6. Note sur la validation par glissement
